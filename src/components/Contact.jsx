...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Option A: Save to Supabase "messages" table (create it in Supabase dashboard)
      ...
      <div className="max-w-xl mx-auto">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            ...
            required
            className="p-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-[var(--text)] dark:text-white focus:outline-none focus:border-[var(--accent)]"
          />
          <input
            name="email"
            type="email"
